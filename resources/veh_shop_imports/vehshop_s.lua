...
AddEventHandler('carshop:table2', function(table)
    if table ~= nil then
        carTable = table
...
RegisterServerEvent('carshop:requesttable2')
AddEventHandler('carshop:requesttable2', function()
    local src = source
    ...
    TriggerClientEvent('veh_shop:returnTable2', user.source, carTable)
    end)
end)
